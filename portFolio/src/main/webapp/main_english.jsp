  ...
  <head>
    ...
    <style>
      * {
      ...
      #SC1 {
        background-image:url("resources/img/f.png");
        background-size:100% 100%;
      }
      #SC2 {
        background-image:url("resources/img/c.png");
        background-size:100% 100%;
      }
      #SC3 {
        background-image:url("resources/img/i.png");
        background-size:100% 100%;
      }
      #slider-div2 {
        width: 100%;
...
<script type="text/javascript">
  ...
  function drawChart() {
         var data = google.visualization.arrayToDataTable([
           ['Categegories', 'Students' , 'Teachers'  ],
           ['2018', 140,     140      ],
           ['2019', 210,  324   ],
           ['2020', 324,  532],
         ]);
         var options = {
           title: 'Number of enrolled teachers and students',
           titleTextStyle: {
               fontSize: 20,
             },
           pointSize: 8,
	...
	function drawChart() {
		...
		var opt = {
					  width: 500,
					  height: 450,
					  title: 'Ratio of specialized teachers',
// 					  pieSliceText: 'label',
					is3D:true,
    ...
    <div id="contentWrap">
      <div id="mainSlider">
        ...
        <%if(userNum!=0){//세션이 존재할때 %>
        	...
        	<a href="noservice_E.jsp"><div class="slideContent" id="SC1"></div></a>
        	<%} %>
        <%}else{//세션이 존재하지 않을때 %>
        <a href="noservice_E.jsp"><div class="slideContent" id="SC1"></div></a>
        <%} %>
         <%if(userNum!=0){ %>
        	...
        	<%}else{ %>
        	<a href="noservice_E.jsp"><div class="slideContent" id="SC2"></div></a>
        	<%} %>
        <%}else{ %>
        <a href="noservice_E.jsp"><div class="slideContent" id="SC2"></div></a>
        <%} %>
      ...
      <div class="mainTitles">- Customer Review -</div>
      <div id="mainReviews">
        <div class="reviewflex">
            ...
            <div class="reviews">
              ...
              <div class="reviewDescWrap">
                <div class="reviewDesc">
                  <div class="rdTitle">My math scores went up.</div>
                  <div class="rdContent">
					Math was my worst subject.<br>
					However, thanks to the teacher I met here,
					I was able to get good scores consistently.
					 <br><br>
                    -California
                  </div>
                </div>
          ...
          <div class="review">
            <div class="reviews">
              ...
              <div class="reviewDescWrap">
                <div class="reviewDesc">
                  <div class="rdTitle">I passed the JLPT N1 exam.</div>
                  <div class="rdContent">
                  To prepare for studying in Japan, I studied Japanese for 4 months
                  with a teacher I met here. It was surprise to me that I passed
                  easily the targeted exam. Thank you very much, teacher.
					<br>
                    -New York
                  </div>
                </div>
        ...
        <div class="reviewflex">
          <div class="review">
            <div class="reviews">
              ...
              <div class="reviewDescWrap">
                <div class="reviewDesc">
                  <div class="rdTitle">Teacher like a friend.</div>
                  <div class="rdContent">
					   The teacher and I both live close to each other,
					   so sometimes we go to a coffee shop for consultation.
					   Many thanks.<br><br>
                    -Chicago
                  </div>
                </div>
          ...
          <div class="review">
            <div class="reviews">
              ...
              <div class="reviewDescWrap">
                <div class="reviewDesc">
                  <div class="rdTitle">My daughter enjoys coding Java.</div>
                  <div class="rdContent">
					My daughter is interested in developing a plugin for
					Minecraft, and so learning how to code in Java.
					She is very happy to have found a good teacher.
      ...
      <div class="mainTitles">- Today's Recommended Teachers -</div>
      <div id="slider-div2">
            ...
            <div class="s2_item">
              ...
              <div class="s2i_content">
                ...
                <div class="s2i_profile">
                  ...
                  <div class="s2i_desc">Education|<%=teacher.gettRecord()%></div>
                </div>
                <div class="s2i_profile">
                  <div class="s2i_svg">
                    <img src="resources/img/class.png" width="24px" />
                  </div>
                  <div class="s2i_desc">Subject|<%=teacher.gettSubject1()%> 등</div>
                </div>
                <div class="s2i_profile">
                  <div class="s2i_svg">
                    <img src="resources/img/range.png" width="24px" />
                  </div>
                  <div class="s2i_desc">Target|<%=range%></div>
                </div>
                <div class="s2i_profile">
                  <div class="s2i_svg">
                    <img src="resources/img/location.png" width="24px" />
                  </div>
                  <div class="s2i_desc">Area|<%=area%></div>
                </div>
              </div>
            </div>
          </a>
      ...
      <div id="chartDiv">
      	<div id="chartComment">
	      	<div class="ccDiv">
		      	...
		      	<div class="ccText">Over 150 new teachers annually</div>
	      	</div>
	      	<div class="ccDiv">
	      		<div class="ccImg"><img src="resources/img/student.svg" style="margin-right: 10px;"/></div>
	      		<div class="ccText">Over 150 new students annually</div>
	      	</div>
      	</div>
      </div>
      <div class="startdiv">
        <%if(userNum!=0){ %>
        <a href="noservice_E.jsp" class="startbutton">Start</a>
        <%}else{ %>
        <a href="noservice_E.jsp" class="startbutton">Start</a>
        <%} %>
      </div>
